...
The rabbits and the wolves are distributed randomly within the environment as shown below. 


\section*{Point A}
In both MATLAB and Python implementations after very few hundred iterations and with the given parameters 
\end{document}
